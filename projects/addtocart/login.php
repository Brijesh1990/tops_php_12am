...
<h2 class="mb-4 text-center fw-bold">Login with Us</h2>
...
<button type="submit" name="login_customer" class="btn btn-primary w-100">Login</button>

<p class="text-center mt-3">
Don't have an account ? <a href="account.php">Register</a>
</p>

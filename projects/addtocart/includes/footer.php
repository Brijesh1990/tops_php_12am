  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <p>
          Your one-stop online store for electronics, fashion, and more.
          We deliver quality products at the best prices.
        </p>
      </div>
      ...
      <div class="col-md-2 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="account.php" class="text-light text-decoration-none">Account</a></li>
      ...
      <div class="col-md-3 mb-4">
        ...
        <p class="mb-1">📧 support@myshop.com</p>
        <p class="mb-1">📞 +91 98765 43210</p>
        <p class="mb-1">📍 Ahmedabad, India</p>
      </div>

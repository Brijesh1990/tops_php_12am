...
<title>Everything delivered in a minutes in all cities clickIt App :: @yield('title-here')</title>
<meta name='viewport' content='width=device-width, initial-scale=1'>
<!-- main css -->
<link rel='stylesheet' type='text/css' media='screen' href="{{asset('clickecomm/user/css/style.css')}}">
<!-- icons cdn -->
  ...
  <div class="max-w-7xl mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 text-sm text-gray-700">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="/products" class="hover:text-green-600">Fruits & Vegetables</a></li>
          <li><a href="/products" class="hover:text-green-600">Dairy & Bakery</a></li>
          <li><a href="/products" class="hover:text-green-600">Snacks & Beverages</a></li>
